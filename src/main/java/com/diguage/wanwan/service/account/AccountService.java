 ...
 *******************************************************************************/
package com.diguage.wanwan.service.account;

import com.diguage.wanwan.dao.UserMapper;
...
import com.diguage.wanwan.service.ServiceException;
...
public class AccountService {
    ...
    public List<User> getAllUser() {
        return (List<User>) userDao.selectByExample(null);
    }
    ...
    public void registerUser(User user) {
        ...
        user.setRoles("user");
        user.setCreatedAt(clock.getCurrentDate());
    ...
    public void deleteUser(Integer id) {
        ...
        taskDao.deleteByExample(example);
    }
